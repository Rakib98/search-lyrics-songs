...
class Lyrics extends Component {
  ...
  render() {
    ...
    if (
      ...
      return (
        <React.Fragment>
          <Link to="/" className="btn btn-dard btn-sm mb-4">
            Back
          </Link>
          <div className="card card-lyrics">
            <h5 className="card-header text-light">
              {track.track_name} by{" "}
              <span className="card-artist"> {track.artist_name} </span>
            </h5>
          ...
          <ul className="list-group mt-3">
            ...
            <li className="list-group-item">
              <strong>Is Explicit? </strong>{" "}
              {track.explicit === 0 ? "No" : "Yes"}
            </li>
            <li className="list-group-item">
              <strong>Release Date: </strong>{" "}
              <Moment format="DD/DD/YYYY">{track.updated_time}</Moment>
            </li>
            <li className="list-group-item">
              <strong>Rating: </strong> {track.track_rating}/100
            </li>
          </ul>
        </React.Fragment>
      );
